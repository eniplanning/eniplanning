...
INSERT INTO eniplanning.plannings (`label`, `date_start_contract`, `date_end_contract`, `date_start_formation`, `date_end_formation`, `date_subscription`, `nb_weeks_formation`, `nb_weeks_enterprise`, `limit_day_formation`, `num_version`, `status`, `is_archived`, `is_model`, `is_broken`, `planning_id`, `code_lieu`, `stagiaire_id`, `formation_id`, `user_id`)
VALUES ('test planning', '2018-06-01', '2019-06-01', '2018-06-01', '2019-06-01', '2018-07-26', 20, 5, NULL, NULL, 1, 0, 0, 0, NULL, 1, 12, '17cdi', 1);
INSERT INTO eniplanning.plannings (`label`, `date_start_contract`, `date_end_contract`, `date_start_formation`, `date_end_formation`, `date_subscription`, `nb_weeks_formation`, `nb_weeks_enterprise`, `limit_day_formation`, `num_version`, `status`, `is_archived`, `is_model`, `is_broken`, `planning_id`, `code_lieu`, `stagiaire_id`, `formation_id`, `user_id`)
VALUES ('test2 planning', '2019-06-01', '2020-06-01', '2019-06-01', '2020-06-01', '2018-07-26', 20, 5, NULL, NULL, 1, 0, 0, 0, NULL, 1, 12, '17cdi', 1);
